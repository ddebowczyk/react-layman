import { JsonValue, LaymanPlacement, LaymanState, LaymanTab, Position } from './model';
...
export type WindowMoveTarget = WindowTarget | {
    kind: "floating";
    position: Position;
};
...
export type LaymanRejectionReason = "invalid-state" | "invalid-id" | "invalid-tab" | "unknown-tab" | "unknown-window" | "unknown-split" | "invalid-target" | "invalid-placement" | "invalid-position" | "invalid-size" | "forbidden" | "duplicate-id";
