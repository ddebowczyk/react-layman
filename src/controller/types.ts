...
import type {LaymanInteractionDecision, LaymanInteractionPolicy, LaymanInteractionViewConfig} from "./policy";
...
export interface LaymanControllerTransition<TData extends JsonValue = JsonValue> {
    ...
    denial?: Extract<LaymanInteractionDecision, {kind: "deny"}>;
...
export type LaymanCommandAuthorizer<TData extends JsonValue = JsonValue> = (
    command: LaymanCommand<TData>,
    meta?: LaymanCommandMeta
